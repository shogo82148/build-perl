...
sub run {
    ...
    # patch perl source to fix build issues on GitHub Actions.
    {
        say "::group::patching perl source";
...

    {
        ...
        # JSON::MaybeXS
        # JSON::MaybeXS doesn't work with perl 5.6.2, skip it. workaround for https://github.com/shogo82148/build-perl/issues/15
        cpan_install('https://cpan.metacpan.org/authors/id/E/ET/ETHER/JSON-MaybeXS-1.004005.tar.gz', 'JSON-MaybeXS', 'JSON::MaybeXS', '5.8.0');
