...
sub run {
    ...
    # so we manually install CPAN modules.
    {
        ...
        # JSON::PP
        # JSON::PP doesn't work with perl 5.6.x, skip it. https://github.com/shogo82148/build-perl/issues/3
        cpan_install('https://cpan.metacpan.org/authors/id/I/IS/ISHIGAKI/JSON-PP-4.16.tar.gz', 'JSON-PP', 'JSON::PP', '5.8.0');
